...
SECRET_KEY = 'django-insecure-hd6m0eo7$_uda#j@bj9av0yud^0c)&@$ohd-8zo+a89+*h1p@#'
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "Pariwartan Portfolio",
    ...
    "copyright": "Pariwartan Poudel",

    # List of model admins to search from the search bar, search bar omitted if excluded
    "search_model": ["auth.User", "portfolio.Profile", "portfolio.Project"],
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://github.com/pariwartan-poudel", "new_window": True},
